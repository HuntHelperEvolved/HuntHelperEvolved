...
public sealed partial class Plugin
{
    ...
    [
        ...
        ("Scout notes and report preview",
            ...
            "Scouting reports group last recorded state by world and expansion. Marked snipes, witnessed kills and unknown deaths remain distinct; Not recorded means absent from the retained list, not proof a mark is absent in an instance. Notes and scout credits precede the intact import code. Large reports may use multiple Discord messages; the preview shows the count and warns if the code is too large to include. Sending refreshes the current train snapshot. While posting, the preview shows the captured report and new note edits wait for the next one. Completion reports retain their separate respawn-window summaries and individual history."),
