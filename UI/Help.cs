...
public sealed partial class Plugin
{
    ...
    [
        ...
        ("Train controls, scouting and reports",
            "Scouting starts paused after login. Resume to join scout credits and pick up new marks. Pause stops new records; existing health and death reports still update. Next Mark selects, flags and announces the next live mark without recording a kill. Next Aetheryte announces and copies its destination without teleporting or moving the flag. A row's TP button teleports; travelling to a rally stop completes it after a short delay. Click a mark's text to flag it; chat echo is optional. The check button records a witnessed kill now or restores a dead mark. Crosshairs records found gone without inventing a kill time; clearing that evidence leaves the mark dead with an unknown time. Hold Ctrl and click the row's X to remove it. With Show spicing markers enabled, right-click the mark row and choose Being spiced.\n\n" +
