...
public sealed partial class Plugin
{
    ...
    [
        ...
        ("Train controls, scouting and reports",
            ...
            "Group by expansion keeps marks together and opens the next unfinished group. Automatic scout names combine with manual credits. Completing the last leg clears credits and removed-name suppression and pauses scouting; partial reports keep the remaining train’s credits. Collapse Train controls & scouts to keep the popout compact. Export codes carry the train's worlds, instances and custom stops.\n\n" +
