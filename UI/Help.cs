...
public sealed partial class Plugin
{
    ...
    [
        ...
        ("Train controls, scouting and reports",
            ...
            "World headings keep marks from different worlds separate. Group expansions within worlds adds expansion headings with independent folding and ordering; Open next automatically opens the next unfinished leg, including on the next world. Automatic scout names combine with manual credits. Type a manual name, then press Enter or Add scout to share it; drafts stay local. Use Remove to remove a committed name. Completing the last leg clears credits and removed-name suppression and pauses scouting; partial reports keep the remaining train’s credits. Collapse Train controls & scouts to keep the popout compact. Export codes carry the train's worlds, instances and custom stops.\n\n" +
            "Next Mark and Next Aetheryte stay above the controls section when it is collapsed. End Train submits the report and resets an unchanged train after Discord success and server acknowledgement. Failed submission or concurrent edits retain it. If acknowledgement is lost, inspect state before posting again. Undo reset is inside the controls section; it restores your saved train locally and turns train sharing off, without replacing your friends' current train."),
