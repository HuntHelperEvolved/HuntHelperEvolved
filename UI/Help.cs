...
public sealed partial class Plugin
{
    ...
    [
        ...
        ("Train controls, scouting and reports",
            ...
            "Setup also manages scout credits. Type a manual name, then press Enter or Add scout to share it; unsubmitted name drafts stay local. Completing the last leg clears credits and removed-name suppression and pauses scouting; partial reports keep the remaining train's credits. Reports offers Scouting report and Train completion, with the relevant Shift-click send button below the preview. Webhook progress and results appear only on Reports in either train view. Conflicting train edits are disabled while posting; Next Mark and Next Aetheryte remain usable on Route.\n\n" +
