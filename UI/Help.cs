...
public sealed partial class Plugin
{
    ...
    [
        ...
        ("Getting around",
            "Train and the /hht popout share Route, Reports and Setup pages. Route shows compact, single-line mark rows with local/shared and preset context. Reports reviews scouting or completion reports, and Setup holds presets, clipboard tools, credits, watches and recovery. Next Mark and Next Aetheryte remain above every page, with a pause/resume icon at the right. Changing page does not change the train or recording state. S Ranks contains timers, mapping and spawn counters. Settings groups preferences by task; Help explains the controls. The Windows menu opens standalone boards and popouts. The plugin installer lists the /hh command family when Hunt Helper is absent, or the /htr family when installed (including disabled copies). Extra aliases remain usable when not held by another plugin. Changes save as you edit.\n\n" +
