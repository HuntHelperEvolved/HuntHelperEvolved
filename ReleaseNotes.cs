...
public static class ReleaseNotes
{
    ...
    public static readonly Release[] All =
    {
        ...
        [
            ...
            new("Train", "A mark is ticked off when it dies, whoever killed it. Its health reaching zero is the signal, which carries as far as the game loads the mark at all; the battle log is watched too, but that only reaches as far as the fight. Marking dead ran off the tally alone, which only reports kills you were credited with.", Kihtli),
